...
/**
 * Created by abeeral-olayan on 11/8/17.
 */
...
public class AddCategory extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ChooseButton = (Button) view.findViewById(R.id.Cimage);
        UploadButton = (Button)view.findViewById(R.id.AddCB);
        CancleButton = (Button) view.findViewById(R.id.CancleCB);
